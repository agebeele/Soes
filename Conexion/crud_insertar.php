...
if (
    ...
    !isset($_REQUEST['direccion'])) {
            ...
            try {
                ...
                $mysqli->query("INSERT INTO tubos_solares (id,compania,cantidad_tubos, cantidad_personas,tiempo_garantia, telefono, pagina_web, correo_e, direccion)
                VALUES ('$id', '$compania', '$cantidad_tubos', '$cantidad_personas','$tiempo_garantia','$telefono','$pagina_web','$correo_e','$direccion')");
