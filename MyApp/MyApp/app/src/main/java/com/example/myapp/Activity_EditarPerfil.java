...
public class Activity_EditarPerfil extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ediatr_perfil);
    ...
    class MiAsyncTask extends AsyncTask<String, String, Void> {
        ...
        protected Void doInBackground(String... parameter) {
            ...
            switch (parameter[0]) {
                case "insertar":
                    msj = obj.InsertarPerfil(parameter[1], parameter[2], parameter[3], parameter[4], parameter[5], parameter[6], parameter[7], parameter[8],parameter[9]);
                    publishProgress(msj);
                    break;
                case "borrar":
                    msj = obj.BorrarPerfil(parameter[1]);
                    publishProgress(msj);
                    break;
                case "actualizar":
                    msj = obj.ActualizarPerfil(parameter[1], parameter[2], parameter[3], parameter[4], parameter[5], parameter[6], parameter[7],parameter[8],parameter[9]);
                    publishProgress(msj);
                    break;
                case "buscar":
                    msj = obj.BuscarPerfil(parameter[1]);
                    publishProgress(msj);
                    break;
                default:
            }
